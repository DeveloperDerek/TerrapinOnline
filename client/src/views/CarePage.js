        ...
        <div className="bg-white">
            ...
            <div className="container-fluid">
                <div className="row p-3">
                    ...
                    {/* Navigation to Animal Care Page */}
                    <div className="col-2">
                        <div className="py-2">
                            ...
                            <ul className="list-group">
                                {turtles.map((turt, idx) => {
                                    if(turt.category === "turtle"){
                                        return(
                                            <li className="list-group-item">{turt.commonName}</li>
                                        )
                                    }
                                })}
                            </ul>
                            ...
                            <ul className="list-group">
                                {turtles.map((tort, idx) => {
                                    if(tort.category === "tortoise"){
                                        return(
                                            <li className="list-group-item">{tort.commonName}</li>
                                        )
                                    }
                                })}
                            </ul>
                    ...
                    <div className="col">
                        ...
                        <div className="clearfix">
                            ...
                            <p>An easy way to tell a tortoise from a turtle is to look at its feet. Tortoises being exclusively land creatures have feet that look similar to tiny elephant feet designed for trucking through on land or burrowing below it. Aquatic turtles have feet that are webbed designed for swimming. The diet between the two is also different. While tortoises are generall vegetarians, other turtles are omnivorous eating plant matter along with insects, fish, and crustaceans.</p>
                        </div>
                        <div clasName="clearfix">
                            <img className="img-fluid col-md-5 float-md-start me-3" src="https://cdn1.bigcommerce.com/server700/6bee4/product_images/uploaded_images/Sulcata2.JPG?_ga=2.111403012.1249514110.1524237470-546948814.1524237470" />
